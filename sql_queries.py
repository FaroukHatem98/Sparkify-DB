...
start_time timestamp NOT NULL, user_id int NOT NULL, level varchar,  artist_id varchar,
session_id int, song_id varchar, location varchar, user_agent varchar,
...
title varchar NOT NULL, artist_id varchar, year int NOT NULL, duration float NOT NULL)
...
WHERE (duration = {})AND(title = '{}') AND (name = '{}')
""")
